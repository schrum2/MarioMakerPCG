...
headers), crops each level to a 20x20 window (best window, or every window with
--sliding_window) and emits a grid of tile ids. ``split`` shuffles a dataset and
...
# ===========================================================================
# build   (was build_dataset_with_ascii.py)
# ===========================================================================
...
# ===========================================================================
# split   (was split_mario_maker_data.py)
# ===========================================================================
...
def main():
    if len(sys.argv) < 2 or sys.argv[1] not in ("build", "split"):
