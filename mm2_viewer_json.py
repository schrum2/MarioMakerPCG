...
# Mirrors the approximations in mm2pipeline_data.swe OBJ_ID_MAP.
ASCII_REPLACEMENTS = {
    "Spike Top":           "s",  # → Spiny
...
# ---------------------------------------------------------------------------
# Items stored INSIDE a block (mirrors mm2pipeline_data.ascii): the block keeps
        ...
        for pass_n in range(3):
            for obj in objects:
                ...
                if obj_name in _SLOPE_NAMES:
                    ...
                    # mm2pipeline_data.swe and the same fix in mm2pipeline_data.ascii.
