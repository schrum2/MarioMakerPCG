...
%PY% -m mm2pipeline_data.dataset build --input "%ASCII%" --output_folder "%DATASET%" --tileset %TILESET% --sliding_window --stride %STRIDE% --window_h %WINDOW% --window_w %WINDOW% --strip_goal --with_images
